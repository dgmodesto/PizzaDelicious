...
namespace PizzaDelicious.Core.Messages.CommomMessages.IntegrationEvents
{
   public  class OrderStockConfirmedEvent : IntegrationEvent
    {
        public OrderStockConfirmedEvent(Guid orderId, Guid clientId, decimal total, ListProdutctOrder listProductOrder, string cardName, string cardNumber, string cardExpiration, string cardCvv)
        {
            OrderId = orderId;
            ClientId = clientId;
            Total = total;
