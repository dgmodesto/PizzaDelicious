...
namespace PizzaDelicious.Api.UI.Controllers {
    ...
    public class CatalogProductsController : ControllerBase {
        ...
        public CatalogProductsController (IProductAppService productAppService, IStockService stockService, INotificationHandler<DomainNotification> notifications, IMediatorHandler mediatorHandler) : base (notifications, mediatorHandler) {
        ...
        /*Products*/
        [HttpGet]
        [Route ("error-generate")]
        public async Task<IActionResult> ErrorGenerate () {
            return BadRequest ("Simulando algum problema na api");
        }
